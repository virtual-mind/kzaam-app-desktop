...
} = require('kzaam-app-desktop-utils');
...
/**
 * The window object that will load the iframe with Kzaam-app.
...
/**
 * Opens new window with index.html(Kzaam Appis loaded in iframe there).
 */
function createJitsiMeetWindow() {
    ...
    /**
     * When someone tries to enter something like kzaam-app://test
     *  while app is closed
...
app.on('second-instance', (event, commandLine) => {
    ...
    if (mainWindow) {
         ...
         * so when someone tries to enter something like kzaamapp://test
 ...
 * so when someone tries to enter something like kzaam-app://test
 * it will trigger this event below
 */
